...
int remove_disciplina(LDisciplinas **pInicio, char codigo_disc[], char periodo[]){
...
{ // Função para remover uma disciplina do aluno
    ...
    if(tipo && foi_removido) printf("Materia removida com sucesso\n");
    
    if(tipo && !foi_removido) printf("Aluno nao cursou essa materia");
