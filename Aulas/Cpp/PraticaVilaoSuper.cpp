...
public:
    ...
    Personagem(const Personagem &p) : 
        nome(p.nome), nomeVidaReal(p.nomeVidaReal),nPoderes(p.nPoderes){
...
class Confronto{
    ...
    string nomeVilao;
    public:
    Confronto(double poderHeroi,string nomeHeroi,double poderVilao, string nomeVilao):
        poderHeroi(poderHeroi),
        nomeHeroi(nomeHeroi),
        poderVilao(poderVilao),
        nomeVilao(nomeVilao)
    {}
    void getResultado(){
        if(poderHeroi>poderVilao) cout << nomeHeroi;
        else if(poderHeroi<poderVilao) cout << nomeVilao;
        else cout << "Empate";
    }
};
